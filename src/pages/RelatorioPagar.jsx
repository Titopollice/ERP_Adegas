...
const RelatorioPagar = () => {
  ...
  return (
    <div className="payables-report-container min-h-screen bg-gradient-to-b text-white flex flex-col items-center justify-center" style={{ backgroundColor: '#001a33' }}>
      <div className="payables-report-box bg-white text-black p-8 rounded-lg shadow-lg w-1/2">
        <h1 className="text-center text-xl font-bold mb-6">Relatório de Contas a Pagar</h1>
